...
window.addEventListener('load', () => {
  ...
  var dictionary = {
    'en': {
      ...
      'home': {
        'me': 'I\'m',
        'sub': 'Angular developer, Fullstack developer, Based on Ottawa(Canada)',
        'hire': 'Hire me',
      ...
      'about': {
        ...
        'desc': 'I am MIHARINIAINA Rilah Mario, Angular / Full-Stack Developer with 6+ years of experience specializing in Angular, TypeScript, and Node.js. Strong expertise in building high-performance, scalable, and maintainable web applications. Proven track record in modernizing legacy systems, integrating RESTful APIs, and maintaining complex applications in Agile environments. Solid understanding of software development best practices, including testing, code reviews, CI/CD, and DevOps principles. Collaborative team player with the ability to challenge technical decisions and contribute to continuous improvement of products and processes.',
      ...
      'study_work': {
        ...
        'diplaume4': 'Master in Computer Methods Applied to Business Management (MIAGE)',
        'diplaume4_desc': 'Université Nice Sophia Antipolis (now part of Université Côte d’Azur), France',
        'diplaume4_spec': 'Specialization in Mobiquity, Big Data and Systems Integration',
        'diplaume4_wes': 'WES evaluation: Master\'s degree',
        'work1': 'Web engineer - Telma media planning',
        'work1_date': 'June 2019 - August 2019',
        'work1_sub1': 'PULSE, Antananarivo, Madagascar (On-site)',
        'work1_sub2': 'Client project: Telma Mediaplanning',
        ...
        'work2_date': 'January 2020 - June 2021',
        'work2_sub1': 'Adrware Consulting, Antananarivo, Madagascar (On-site)',
        'work2_sub2': 'Client project: Semwee, France',
        'work2_desc': '- Development and maintenance of internal software \n- Realization and development of functional requirements \n- Proposal of digital solutions',
        'work3': 'Scrum master / Project Manager',
        'work3_date': 'July 2021 - October 2021',
        'work3_sub1': 'Adrware Consulting, Madagascar (On-site)',
        'work3_sub2': 'Client project: Semwee, France',
        ...
        'work4_sub1': 'Adrware Consulting, Madagascar (Hybrid)',
        'work4_sub2': 'Client project: SCOPLAN, France',
      ...
      'service': {
        ...
        'desc2': 'During and after University, I mastered various web technology like php, javascript, symfony, codeigniter, angular, nodesJS, java, etc... which allows me to become fullstack developer.',
      ...
      'quotes': {
        ...
        'q2': '"A problem is a chance for you to do your best."',
        'q3': '"We become what we think about."',
        'q4': '"The present is the anvil where the future is made."',
        'pers1': "Software engineer & Digital content creator",
        'pers2': "Jazz Musician",
        'pers3': "Author",
        'pers4': "Poet"
      },
    ...
    'fr': {
      ...
      'home': {
        'me': 'Je suis',
        'sub': 'Développeur Angular, Développeur Fullstack, Basé à Ottawa(Canada)',
        'hire': 'Engagez-moi',
      ...
      'about': {
        ...
        'desc': 'Je suis MIHARINIAINA Rilah Mario, développeur Angular / Full-Stack avec plus de 6 ans d’expérience, spécialisé en Angular, TypeScript et Node.js, avec une forte expertise dans le développement d’applications web performantes et maintenables. Expérience dans la refonte d’applications existantes, l’intégration d’APIs REST et la maintenance de systèmes complexes en environnement Agile. Solide compréhension des bonnes pratiques de développement logiciel, incluant les tests, les revues de code, l’intégration continue et les principes DevOps. À l’aise dans des équipes multidisciplinaires, avec une capacité à collaborer, challenger les choix techniques et contribuer à l’amélioration continue des produits et des processus.',
        'information': 'Informations',
      ...
      'study_work': {
        ...
        'diplaume3': 'Cinema - Image - 3D',
        'diplaume3_desc': 'CFP Image E-MEDIA, Antananarivo',
        'diplaume4': 'Master en Méthodes Informatiques Appliquées à la Gestion des Entreprises (MIAGE)',
        'diplaume4_desc': 'Université Nice Sophia Antipolis (maintenant partie de Université Côte d’Azur), France',
        'diplaume4_spec': 'Spécialisation en Mobiquity, Big Data et Systems Integration',
        'diplaume4_wes': 'Évaluation WES: Diplôme de Master',
        'work1': 'Ingénieur d\'étude et de développement informatique',
        'work1_date': 'Juin 2019 - Août 2019',
        'work1_sub1': 'PULSE, Antananarivo, Madagascar (Sur site)',
        'work1_sub2': 'Client project: Telma Mediaplanning',
        ...
        'work2_date': 'Janvier 2020 - Juin 2019',
        'work2_sub1': 'Adrware Consulting, Antananarivo, Madagascar (Sur site)',
        'work2_sub2': 'Projet client: Semwee, France',
        'work2_desc': '- Développement et maintenance des logiciels internes \n- Conception et développement des besoins fonctionnels \n- Proposition des solutions digitales.',
        'work3': 'Scrum master / Chef de projet',
        'work3_date': 'Juillet 2021 - Octobre 2021',
        'work3_sub1': 'Adrware Consulting, Madagascar (On-site)',
        'work3_sub2': 'Client project: Semwee, France',
        ...
        'work4_sub1': 'Adrware Consulting, Madagascar (Hybride)',
        'work4_sub2': 'Client project: SCOPLAN, France',
      ...
      'quotes': {
        ...
        'q2': '"Un problème est une chance pour vous de faire de votre mieux."',
        'q3': '"Nous devenons ce à quoi nous pensons."',
        'q4': '"Le présent est l\'enclume où le futur se forge."',
        'pers1': "Ingénieur logiciel & Créateur de contenu digital",
    ...
    'mg': {
      ...
      'home': {
        'me': 'Izaho dia',
        'sub': 'Développeur Angular, Développeur Fullstack, Monina eto Ottawa(Canada)',
        'hire': 'Hampiasa ahy',
      ...
      'about': {
        ...
        'title': 'Fullstack Developer',
        'desc': 'MIHARINIAINA Rilah Mario no anarako, développeur Angular / Full-Stack manana traikefa mihoatra ny 6 taona, manam-pahaizana manokana amin\'ny Angular, TypeScript ary Node.js, manana fahaiza-manao matanjaka amin\'ny fananganana rindranasa web avo lenta, matanjaka sy maharitra. Traikefa amin\'ny fanavaozana rafitra efa misy, fampidirana API REST ary fikojakojana rafitra sarotra amin\'ny tontolo Agile. Fahatakarana matanjaka ny fomba fanao tsara indrindra amin\'ny fampandrosoana rindrambaiko, ao anatin\'izany ny fitsapana, fijerena kaody, CI/CD, ary DevOps. Efa zatra miara-miasa tsara amin\'ny ekipa marolafy, afaka manampy amin\'ny ny safidy ara-teknika ary mandray anjara amin\'ny fanatsarana mitohy ny vokatra sy ny fizotran\'asa.',
        'information': 'Informations',
      ...
      'study_work': {
        ...
        'diplaume3': 'Cinema - Image - 3D',
        'diplaume3_desc': 'CFP Image E-MEDIA, Antananarivo',
        'diplaume4': 'Master amin\'ny Méthodes Informatiques Appliquées à la Gestion des Entreprises (MIAGE)',
        'diplaume4_desc': 'Université Nice Sophia Antipolis (ankehitriny dia ampahany amin\'ny Université Côte d’Azur), France',
        'diplaume4_spec': 'Specialisation en Mobiquity, Big Data et Systems Integration',
        'diplaume4_wes': 'WES evaluation: Master\'s degree',
        ...
        'work2': 'Développeur MEAN Stack',
        'work2_date': 'Janoary 2020 - Jiona 2020',
        'work2_sub1': 'Adrware Consulting, Antananarivo, Madagascar (On-site)',
        'work2_sub2': 'Client project: Semwee, France',
        'work2_desc': '- Fiantohana ny fandehan\'ny asa efa vita. \n- Fanaovana ireo asa ara-kajy mirindra rehetra ilain\'ny orin\'asa. \n- Tolo-kevitra ny amin\'ny fanatsarana kokoa ny asa nomerika.',
        'work3': 'Scrum master / Chef de projet',
        'work3_date': 'Jiolay 2021 - Oktobra 2021',
        'work3_sub1': 'Adrware Consulting, Madagascar (On-site)',
        'work3_sub2': 'Client project: Semwee, France',
      ...
      'quotes': {
        'q1': '"Mora mahay, tia mianatra zava-baovao sy mampitombo ny traikefa efa hanako aho."',
        'q2': '"Ny olana iray dia tombony ahafahanao manome izay tsara indrindra avy aminao."',
        'q3': '"Izay ao antsaintsika no handrafitra antsika."',
        'q4': '"Ny ankehitriny no lasitra andrafetana ny ho avy."',
        'pers1': "Injeniera rindrambaiko & Mpamorona votoaty nomerika",
  ...
  globalTranslate.addEventListener('change', function () {
    ...
    try {
      ...
      // Réinitialiser Typed.js avec les nouvelles chaînes traduites
      if (window.typedInstance) {
        window.typedInstance.destroy();
      }
      var typed_strings = $('.hero .hero-text .typed-text').text();
      window.typedInstance = new Typed('.hero .hero-text h2', {
